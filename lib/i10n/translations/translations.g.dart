...
enum AppLocale with BaseAppLocale<AppLocale, Translations> {
	...
	id(languageCode: 'id', build: _TranslationsId.build);
...
class _TranslationsErrorsEn {
	...
	// Translations
	String get somethingWrong => 'Something\'s Wrong';
}
...
// Path: <root>
class _TranslationsId extends Translations {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	_TranslationsId.build({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = TranslationMetadata(
		    locale: AppLocale.id,
		    overrides: overrides ?? {},
	...
	@override late final _TranslationsId _root = this; // ignore: unused_field
...
// Path: errors
class _TranslationsErrorsId extends _TranslationsErrorsEn {
	_TranslationsErrorsId._(_TranslationsId root) : this._root = root, super._(root);

	@override final _TranslationsId _root; // ignore: unused_field

	// Translations
	@override String get somethingWrong => 'Terjadi Kesalahan';
}

// Path: general
class _TranslationsGeneralId extends _TranslationsGeneralEn {
	_TranslationsGeneralId._(_TranslationsId root) : this._root = root, super._(root);
